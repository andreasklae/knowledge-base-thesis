...
- Local MCP server support in the [Claude Desktop apps](https://claude.ai/redirect/website.v1.1415a309-b9b6-471e-aa1b-1f07d4d50c7b/download)
...
Developers can start building and testing MCP connectors today. All [Claude.ai](http://claude.ai/redirect/website.v1.1415a309-b9b6-471e-aa1b-1f07d4d50c7b) plans support connecting MCP servers to the Claude Desktop app.
...
- Install pre-built MCP servers through the [Claude Desktop app](https://claude.ai/redirect/website.v1.1415a309-b9b6-471e-aa1b-1f07d4d50c7b/download)
